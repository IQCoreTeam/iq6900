...
| **bags** | Launch tokens on Solana via bags.fm. Fee sharing: 50% IQLabs / 50% Eliza OS. |
...
7. LAUNCH    — bags.fm to deploy new tokens with fee sharing (50% IQLabs / 50% Eliza OS)
